...
const GLchar *fragmentShaderSource = R"(
 ...
 void main()
 {
	vec2 offsetCoords = tex_coord + tex_offset;
    color = texture(tex_buff, offsetCoords);
 }
 )";
...
int main()
{
    ...
    GLuint personagemVAO = setupSprite();

    // Carregando uma textura
    GLuint texID = loadTexture("../assets/sprites/Vampirinho.png");
    GLuint bgTexID = loadTexture("../assets/backgrounds/platformer_background_3.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glfwPollEvents();
        // Atualiza o uniform no shader com o valor de xPos
    ...
    glDeleteVertexArrays(1, &personagemVAO);
